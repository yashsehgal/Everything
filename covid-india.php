...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="http://covid19tracking.gq">COVID-19 Tracker<i class="fas fa-virus fa-lg ml-2"></i></a>
	...
	<div class="jumbotron text-center">
		...
		<hr class="my-4">
		<a class="btn btn-dark btn-lg" href="http://covid19tracking.gq" role="button">View COVID-19 World Data</a>
	</div>
	...
	<div class="container">
		<h3 class="text-center text-primary">COVID-19 Live Data Chart</h3>
	</div>
